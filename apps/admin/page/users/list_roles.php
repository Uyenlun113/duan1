...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr"
  ...
  <body>
    <?php @include "../../controllers/roles_controller.php" ?>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">Trang quản trị /</span> Danh sách quyền
              </h4>
              <div class="card">
...
?>
                      <tr>
                        ...
                        <td style="width:15%">
                          <?php echo $roles['roles_code'] ?>
                        </td>
                        <td><span><?php echo $roles['roles_name'] ?></span></td>

                        <td><span><?php echo $roles['create_date'] ?></span></td>
                        <td>
                          <a href="update_rooms.php?action=update&update_rooms=<?= $staff['id'] ?>">
                            <button class="btn btn-sm btn-warning btn-icon">
                              <i class="fa-regular fa-pen-to-square fa-md"></i>
                            </button>
                          </a>
                          <a href="list_rooms.php?action=delete&delete_rooms_id=<?= $staff['id'] ?>">
