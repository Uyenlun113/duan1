                ...
                return (
                  ...
                  t(this).each(function () {
                    var o = t(this),
                      ...
                      v = l(
                        l(t(this).find("[data-repeater-item]"), r.repeaters)
                          .first()
                    ...
                    var $,
                      x =
                        (($ = function (i, a, o) {
                          ...
                          y(o, i, function (e) {
                            var n = t(this);
                            l(n.find("[data-repeater-item]"), e.repeaters).each(
                              function () {
                                var r = n
                                  .find("[data-repeater-list]")
                                  .data("repeater-list");
                      ...
                      k = function (t) {
                        var e = d.clone();
                        x(e, t), r.repeaters && g(e), f.call(e.get(0));
                      };
                    (i = function (t) {
                      h().remove(), u(t, k);
                    }),
                      l(o.find("[data-repeater-create]"), r.repeaters).click(
                        function () {
                          k();
                        }
                      ),
