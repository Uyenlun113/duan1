  ...
  var p = document.getElementById("barChart"),
      ...
      (p &&
        new Chart(p, {
          ...
          options: {
            ...
            scales: {
              x: {
                grid: { color: s, drawBorder: !1, borderColor: s },
                ticks: { color: d },
              },
              y: {
                min: 0,
      ...
      (p &&
        new Chart(p, {
          ...
          options: {
            ...
            animation: { duration: 500 },
            elements: {
              bar: { borderRadius: { topRight: 15, bottomRight: 15 } },
            },
            plugins: {
              tooltip: {
                rtl: isRtl,
            ...
            scales: {
              x: {
                min: 0,
                grid: { color: s, borderColor: s },
                ticks: { color: d },
              },
              y: {
                grid: { borderColor: s, display: !1, drawBorder: !1 },
                ticks: { color: d },
              },
            },
          },
        ...
        new Chart(p, {
          ...
          data: {
            ...
            datasets: [
              {
                data: [
                  80, 150, 180, 270, 210, 160, 160, 202, 265, 210, 270, 255,
                  290, 360, 375,
                ],
                label: "Europe",
              ...
              {
                data: [
                  80, 125, 105, 130, 215, 195, 140, 160, 230, 300, 220, 170,
                  210, 200, 280,
                ],
                label: "Asia",
    ...
    p =
      (p &&
        ...
        y.addColorStop(1, "rgba(151, 135, 255, 0.8)"),
        (b = p
          .getContext("2d")
          .createLinearGradient(0, 0, 0, 150)).addColorStop(
          0,
        ...
        b.addColorStop(1, "rgba(255, 135, 135, 0.8)"),
        new Chart(p, {
          type: "radar",
          data: {
          ...
          options: {
            ...
            scales: {
              r: {
                ticks: { maxTicksLimit: 1, display: !1, color: d },
                grid: { color: s },
                angleLines: { color: s },
                pointLabels: { color: d },
              },
      ...
      (p &&
        new Chart(p, {
          ...
          options: {
            ...
            animation: { duration: 500 },
            scales: {
              r: { ticks: { display: !1, color: d }, grid: { display: !1 } },
            },
            plugins: {
              tooltip: {
                rtl: isRtl,
      ...
      (y &&
        new Chart(y, {
            ...
            datasets: [
              {
                label: "Africa",
                data: [
                  40, 55, 45, 75, 65, 55, 70, 60, 100, 98, 90, 120, 125, 140,
                  155,
                ],
                tension: 0,
                fill: !0,
              ...
              },
              {
                label: "Europe",
                data: [
                  240, 195, 160, 215, 185, 215, 185, 200, 250, 210, 195, 250,
                  235, 300, 315,
                ],
                tension: 0,
                fill: !0,
          ...
          options: {
            ...
            scales: {
              x: {
                grid: { color: "transparent", borderColor: s },
                ticks: { color: d },
              },
              y: {
                min: 0,
      ...
      options: {
        ...
        scales: {
          x: {
            min: 0,
            max: 140,
            grid: { color: s, drawTicks: !1, drawBorder: !1, borderColor: s },
            ticks: { stepSize: 10, color: d },
          },
          y: {
            min: 0,
