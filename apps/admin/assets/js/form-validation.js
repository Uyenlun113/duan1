  ...
  document.addEventListener("DOMContentLoaded", function (e) {
    {
      const t = document.getElementById("formValidationExamples"),
        ...
        r = FormValidation.formValidation(t, {
          fields: {
            ...
            formValidationFile: {
              validators: { notEmpty: { message: "Please select the file" } },
            },
            formValidationDob: {
              validators: {
            ...
            formValidationTech: {
              validators: { notEmpty: { message: "Please select technology" } },
            },
            formValidationHobbies: {
              validators: {
                notEmpty: { message: "Please select your hobbies" },
              },
            },
            formValidationBio: {
              validators: {
            ...
            formValidationPlan: {
              validators: {
                notEmpty: { message: "Please select your preferred plan" },
              },
            },
            formValidationSwitch: {
              validators: {
                notEmpty: { message: "Please select your preference" },
              },
            },
            formValidationCheckbox: {
              validators: { notEmpty: { message: "Please confirm our T&C" } },
            },
          },
          plugins: {
      ...
      flatpickr(t.querySelector('[name="formValidationDob"]'), {
        ...
        isRtl &&
          (a = [].slice.call(document.querySelectorAll(".typeahead"))) &&
          a.forEach((e) => {
