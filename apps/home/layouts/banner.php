    ...
    <div class="auto-container">
      <div class="checkout-form">
        <div class="checkout-field">
          <h6>Check in</h6>
          <div class="chk-field">
            <input class="date-pick req" type="text" placeholder="dd-mm-yyyy" />
        ...
        <div class="checkout-field">
          <h6>Check out</h6>
          <div class="chk-field">
            <input class="date-pick" type="text" placeholder="dd-mm-yyyy" />
            <i class="fa fa-calendar"></i>
          </div>
        </div>
        ...
        <button href="#" class="theme-btn btn-style-one"><span class="btn-title">check now</span></button>
      </div>
    </div>
  </div>
</section>