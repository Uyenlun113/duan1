...
<!-- Mirrored from kodesolution.com/html/2023/hoexr-html/page-about.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Nov 2023 04:42:05 GMT -->
<head>
<meta charset="utf-8">
...
<div class="page-wrapper">
  ...
  <!-- Main Header-->
    ...
    <div class="auto-container">
      ...
      <div class="main-box">
        <div class="logo-box">
          <div class="logo"><a href="index.php"><img src="images/logo-v5-black.png" alt="" title="Tronis"></a></div>
        </div>
        <!--Nav Box-->
        <div class="nav-outer">
            ...
            <ul class="navigation">
              <li class="dropdown"><a href="#">Home</a>
                <ul>
                  ...
                  <li><a href="index.php">Home page 02</a></li>
        ...
        <div class="content-column col-xl-6 col-lg-6 order-lg-2 wow fadeInRight" data-wow-delay="600ms">
          <div class="inner-column">
            <div class="sec-title">
              ...
              <div class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do <br>tempor incididunt ut labore et dolore magna aliqua. Quis ipsum <br>suspendisse ultrices gravida. Risus commodo maecenas accumsan<br> lacus vel facilisis.</div>
            </div>
            <div class="outer-box">
        ...
        <div class="content-column col-xl-8">
          <div class="inner-column">
            <div class="sec-title"> <span class="sub-title">EAT FROM THE LAND</span>
              ...
              <div class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt<br>
        ...
        <div class="row">
          ...
          <div class="footer-column col-lg-4 col-sm-6">
            <div class="footer-widget about-widget wow fadeInLeft">
              <div class="widget-content">
                ...
                <div class="text">Welcome to the best five-star deluxe hotel in New <br>York. Hotel elementum sesue the aucan vestibulum <br>aliquam justo in sapien rutrum volutpat.</div>
            ...
            <div class="footer-widget links-widget wow fadeInLeft" data-wow-delay="200ms">
              ...
              <div class="widget-content">
                <ul class="user-links">
                  ...
                  <li><a href="#"><i class="fa-solid fa-crosshairs"></i>Rooms & Suites</a></li>
                  <li><a href="#"><i class="fa-solid fa-crosshairs"></i>Restaurant</a></li>
                  <li><a href="#"><i class="fa-solid fa-crosshairs"></i>Spa & Wellness</a></li>
            ...
            <div class="footer-widget info-widget wow fadeInLeft" data-wow-delay="300ms">
              ...
              <div class="widget-content">
                ...
                <article class="recent-post">
                  <div class="inner">
                    <div class="post-info"><i class="fas fa-phone"></i> 1800-121-3637</div>
          ...
          <div class="footer-column col-lg-3 col-sm-6">
            <div class="footer-widget news-widget wow fadeInLeft" data-wow-delay="400ms">
              ...
              <div class="text">Lorem ipsum dolor sit amet consectetur Augue id fermentum</div>
              ...
              <div class="text"><i class="fa-regular fa-circle-check"></i>I agree to all terms and policies</div>
            </div>
          </div>
        </div>
      </div>
