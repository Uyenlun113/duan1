...
<html lang="en" class="light-style layout-wide  customizer-hide" dir="ltr" data-theme="theme-default"
  ...
  <body>
    <?php @include "./controllers/forgot_pasword.php" ?>
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
          <div class="w-100 d-flex justify-content-center">
            <img src="assets/img/illustrations/boy-with-rocket-light.png" class="img-fluid" alt="Login image"
              width="600" data-app-dark-img="illustrations/girl-unlock-password-dark.png"
          ...
          <div class="w-px-400 mx-auto">
            ...
            <div class="app-brand mb-5">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo demo text-body fw-bold">Sneat</span>
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-2">Quên mật khẩu ? 🔒</h4>
            <p class="mb-4">Vui lòng nhập email để lấy lại mật khẩu !</p>
